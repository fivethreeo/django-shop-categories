...
def make_category_tree():
    ...
    level1_second.save()
    level2_first = Category(name='Level2 first', slug=slugify('Level2 first sub'), active=True, parent=level1_first)
    level2_first.save()
    level2_first_sub = Category(name='Level2 first sub', slug=slugify('Level2 first'), active=True, parent=level2_first)
